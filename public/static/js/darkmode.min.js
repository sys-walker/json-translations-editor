...
class DarkMode {
  ...
  setDarkMode(e, o = !0) {
    ...
    if (0 == t.length)
      ...
      for (let o = 0; o < t.length; o++)
        t[o].setAttribute('data-' + DarkMode.DATA_SELECTOR, e ? DarkMode.VALUE_DARK : DarkMode.VALUE_LIGHT);
  ...
  toggleDarkMode(e = !0) {
    ...
    (o = t
      ? t.getAttribute('data-' + DarkMode.DATA_SELECTOR) == DarkMode.VALUE_DARK
      : this.documentRoot.classList.contains(DarkMode.CLASS_NAME_DARK)),
      this.setDarkMode(!o, e);
  }
  resetDarkMode() {
  ...
  static getColorScheme() {
    ...
    return darkmode.documentRoot.classList.contains(DarkMode.CLASS_NAME_DARK)
      ? DarkMode.VALUE_DARK
